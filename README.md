...
simplfiy it, use the updated [SPATS tool](https://github.com/LucksLab/spats) file formats as inputs,
...
| `shape_intercept` | Real | -0.3 | Intercept used to convert SHAPE reactivities to `pf` energy biases:  `pf = m * ln[rho] + b1 |
